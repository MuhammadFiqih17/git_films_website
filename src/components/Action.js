...
import act2 from '../assets/action/act2.png';
import act3 from '../assets/action/act3.png';
import act4 from '../assets/action/act4.png';

const action = () => {
    return (
        <Container id="act"><br />
            <h1 className='title text-white'>ACTION MOVIES</h1>
            <Row>
                ...
                <Col md={4} className="movwrap">
                <Card className="bg-dark text-white text-center movimg mt-5">
                    <Image src={act2} className="images" />
                    <div className="bg-dark">
                        <div className="p-2 m-1 text-white">
                        <Card.Title>QUANTUMANIA</Card.Title>
                    <Card.Text>
                        This is a wider card with supporting text below as a natural lead-in
                    </Card.Text>
                    <Card.Text>Last updated 3 mins ago</Card.Text>
                ...
                <Col md={4} className="movwrap">
                <Card className="bg-dark text-white text-center movimg mt-5">
                    <Image src={act4} className="images" />
                    <div className="bg-dark">
                        <div className="p-2 m-1 text-white">
                        <Card.Title>MISSION IMPOSSIBLE: DEAD RECKONING PART 1</Card.Title>
                    <Card.Text>
                        This is a wider card with supporting text below as a natural lead-in
                    </Card.Text>
                    <Card.Text>Last updated 3 mins ago</Card.Text>
